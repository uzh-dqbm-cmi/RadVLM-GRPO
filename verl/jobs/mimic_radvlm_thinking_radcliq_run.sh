...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files="${DATA_DIR}/data/mimic_radvlm_thinking/train.parquet" \
    data.val_files="${DATA_DIR}/data/mimic_radvlm_thinking/val.parquet" \
    ...
    actor_rollout_ref.model.path="/capstor/store/cscs/swissai/a135/RadVLM_project/models/qwen3VL_full_final_Thinking_GT" \
