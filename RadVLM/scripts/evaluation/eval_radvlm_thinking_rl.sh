...
python3 -m radvlm.evaluation.evaluate_instructions --task report_generation --model_name "/iopsstor/scratch/cscs/user/checkpoints/mimic_rg_radvlm_thinking_radcliq_attempt_4_gt/global_step_300/actor_hf_qwen_radvlm_thinking_rl" --temp 0.0 --max_new_tokens 4096 --vllm --r1
