...
accelerate launch --num_processes=4 -m radvlm.evaluation.evaluate_instructions --task report_generation --model_name "microsoft/llava-rad" --load_outputs "/users/user/repos/RadVLM-GRPO/RadVLM/radvlm/evaluation/results/keep/llava_rad/llava-rad_report_generation_output.json"
