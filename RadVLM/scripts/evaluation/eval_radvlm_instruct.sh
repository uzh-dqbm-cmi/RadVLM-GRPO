...
python3 -m radvlm.evaluation.evaluate_instructions --task report_generation --model_name "/capstor/store/cscs/swissai/a135/RadVLM_project/models/qwen3VL_full_final" --vllm
