...
python3 -m radvlm.evaluation.evaluate_instructions --task report_generation --model_name "/iopsstor/scratch/cscs/user/checkpoints/mimic_rg_qwen3vl_thinking_radcliq_attempt_5/global_step_300/actor_hf_qwen_qwen3_vl_thinking_rl" --temp 1.0 --max_new_tokens 4096 --vllm --r1 --remove_think_suffixe
