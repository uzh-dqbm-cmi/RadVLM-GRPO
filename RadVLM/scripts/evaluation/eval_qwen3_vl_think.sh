...
python3 -m radvlm.evaluation.evaluate_instructions --task report_generation --model_name "Qwen/Qwen3-VL-8B-Thinking" --temp 1.0 --max_new_tokens 4096 --vllm --r1 --remove_think_suffixe
