...
python3 -m radvlm.evaluation.evaluate_instructions --task report_generation --model_name "/iopsstor/scratch/cscs/user/checkpoints/mimic_rg_radvlm_instruct_radgraph_attempt_1/global_step_300/actor_hf_qwen_radvlm_instruct_rl_radgraph" --temp 0.0 --max_new_tokens 1024 --vllm
